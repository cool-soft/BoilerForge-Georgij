...
if __name__ == '__main__':
    ...
    loaded_dataset = load_dataset(config.BOILER_PREPROCESSED_HEATING_CIRCUIT_DATASET_PATH)
    ...
    for column_name in columns_to_plot:
        ...
        data_to_plot = average_values(data_to_plot, boiler_temp_smooth_size)
